            ...
            try
            {
                if (TM_Server_URL.isNull())
                {
                    ...
                    else
                    {
                        ...
                        "HttpContextFactory.Context is null = {0}".debug(HttpContextFactory.Context.isNotNull());
                        "HttpContextFactory.Request = {0}".debug(HttpContextFactory.Request.isNotNull());
                    }
                }
            }
            catch(Exception ex)
